...
public class CseSem4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn316.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn316.setText("CSE316");
        btn316.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCSE316ActionPerformed(evt);
            }
        });
        getContentPane().add(btn316);
        btn316.setBounds(165, 271, 170, 31);

        btn310.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btn310.setText("CSE310");
        btn310.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCSE310ActionPerformed(evt);
            }
        });
        getContentPane().add(btn310);
        btn310.setBounds(165, 320, 170, 31);
